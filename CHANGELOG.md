...
* **dns:** complete DNS server implementation with caching and tests ([e0d79b9](https://github.com/GrammaTonic/pihole-network-analyzer/commit/e0d79b906478cb8bf38541f66b3f09c25d122a08))
...
* **ci:** resolve DNS network access issues in CI pipeline ([420815e](https://github.com/GrammaTonic/pihole-network-analyzer/commit/420815ec95b8a6801362e4dd43bdc729e852a07e))
...
* **format:** apply gofmt formatting for CI compliance ([e583cb3](https://github.com/GrammaTonic/pihole-network-analyzer/commit/e583cb31a5c1aca3ad6e11332047b89966b3dec4))
* **format:** apply gofmt formatting to all DNS server code ([eba674f](https://github.com/GrammaTonic/pihole-network-analyzer/commit/eba674f26cf2ec8575c0b9f4d37396f92284a442))
...
* **merge:** resolve conflicts from merging main into copilot/fix-23 ([18e87f2](https://github.com/GrammaTonic/pihole-network-analyzer/commit/18e87f26a0b1dd65905810ad65b80104026af271))
...
* **tests:** resolve syntax and lint errors in notifications_test.go ([bfbc513](https://github.com/GrammaTonic/pihole-network-analyzer/commit/bfbc5138a431fb1aa4fb089a3fa77dea05b110fd))
